...
class LatestAndTrendingDetailsPage extends StatefulWidget {
  const LatestAndTrendingDetailsPage({super.key});

  @override
  State<LatestAndTrendingDetailsPage> createState() =>
      _LatestAndTrendingDetailsPageState();
}

class _LatestAndTrendingDetailsPageState
    extends State<LatestAndTrendingDetailsPage> with TickerProviderStateMixin {
