...
import 'package:flutter_ott_info/Presentation/Pages/HomePages/AllHomeTabBarPages/HomeAllBody/original_special_series_details_page.dart';

class OriginalSpecialSeriesPage extends StatefulWidget {
  const OriginalSpecialSeriesPage({super.key});

  @override
  State<OriginalSpecialSeriesPage> createState() =>
      _OriginalSpecialSeriesPageState();
}

class _OriginalSpecialSeriesPageState extends State<OriginalSpecialSeriesPage> {
  List allImage = [
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: () {
                  Get.to(
                    () => const OriginalSpecilaSeriesDetailsPage(),
