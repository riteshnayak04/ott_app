...
class TopMoviesDetalsPage extends StatefulWidget {
  const TopMoviesDetalsPage({super.key});

  @override
  State<TopMoviesDetalsPage> createState() => _TopMoviesDetalsPageState();
}

class _TopMoviesDetalsPageState extends State<TopMoviesDetalsPage>
