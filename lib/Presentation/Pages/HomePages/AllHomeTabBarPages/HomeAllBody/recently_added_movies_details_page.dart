...
class RecentlyAddedMovieDetailsPage extends StatefulWidget {
  const RecentlyAddedMovieDetailsPage({super.key});

  @override
  State<RecentlyAddedMovieDetailsPage> createState() =>
      _RecentlyAddedMovieDetailsPageState();
}

class _RecentlyAddedMovieDetailsPageState
    extends State<RecentlyAddedMovieDetailsPage> with TickerProviderStateMixin {
