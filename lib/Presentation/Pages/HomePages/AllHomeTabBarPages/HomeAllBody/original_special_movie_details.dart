...
class OriginalSpecialMovieDetails extends StatefulWidget {
  const OriginalSpecialMovieDetails({super.key});

  @override
  State<OriginalSpecialMovieDetails> createState() =>
      _OriginalSpecialMovieDetailsState();
}

class _OriginalSpecialMovieDetailsState
    extends State<OriginalSpecialMovieDetails> with TickerProviderStateMixin {
