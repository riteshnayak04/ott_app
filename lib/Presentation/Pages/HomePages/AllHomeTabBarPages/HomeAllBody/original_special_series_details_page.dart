...
class OriginalSpecilaSeriesDetailsPage extends StatefulWidget {
  const OriginalSpecilaSeriesDetailsPage({super.key});

  @override
  State<OriginalSpecilaSeriesDetailsPage> createState() =>
      _OriginalSpecilaSeriesDetailsPageState();
}

class _OriginalSpecilaSeriesDetailsPageState
    extends State<OriginalSpecilaSeriesDetailsPage>
