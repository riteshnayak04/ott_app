...
class SonyLatestMoviesPage extends StatefulWidget {
  const SonyLatestMoviesPage({super.key});

  @override
  State<SonyLatestMoviesPage> createState() => _SonyLatestMoviesPageState();
}

class _SonyLatestMoviesPageState extends State<SonyLatestMoviesPage> {
  List allImage = [
